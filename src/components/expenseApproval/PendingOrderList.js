                    ...
                    >
                      ...
                      <td className="whitespace-nowrap px-6 py-4 flex justify-center gap-3">
                        {item.AppStatus === 1 ? (
                          <Link
                            href={
                                `/dashboard/expense-approval/check/${item.BDExpReqID}`
                            }
                          >
                          ...
                          <Link href={
                            `/dashboard/expense-approval/authorization/${item.BDExpReqID}`
                            }>
                            <button className="bg-gray-300 px-1 py-[2px]">
                              Authorization
                            </button>
                          ...
                          <Link href={
                            `/dashboard/expense-approval/approval/${item.BDExpReqID}`
                            }>
                            <button className="bg-gray-300 px-1 py-[2px]">
                              Approval
                            </button>
