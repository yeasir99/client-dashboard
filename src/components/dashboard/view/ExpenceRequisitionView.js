...
const ExpenceRequisitionView = ({id}) => {
    const {status, data} = useGetData(`https://kblsf.site/DLogicKBL/salesforce_api.php?action=get_BDExpReqAll&BDExpReqID=${id}`)
  if(status === 'pending'){
              ...
              <tbody>
                ...
                <tr className="border-b border-neutral-200 dark:border-white/10">
                  ...
                  <td className="whitespace-nowrap px-6 py-4 flex justify-center gap-3 font-medium">
                    {data.BDExpReqDetails.length && data.BDExpReqDetails.reduce(
