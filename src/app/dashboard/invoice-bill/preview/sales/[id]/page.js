                ...
                <div>
                  <p>
                    <span className="font-semibold">
                      Party Name: {state.data.InvoiceMaster.PartyName}
                    </span>
                  </p>
                  <p>
                    <span className="font-semibold">
                      Party Address: {state.data.InvoiceMaster.Address}
                    </span>
                  </p>
                  <p>
                    <span className="font-semibold">
                      Phone No: {state.data.InvoiceMaster.ContactNumber}
                    </span>
                  </p>
                </div>
              ...
              <tbody>
                ...
                <td
                  ...
                  <td className="whitespace-nowrap px-6 py-4 flex justify-center gap-3 font-medium">
                    {formatAmountWithCommas(Number(state.data.InvoiceMaster.TotalAmount))}
                  </td>
                </tr>
                <tr className="border-b border-neutral-200 dark:border-white/10">
                <td
                  ...
                  <td className="whitespace-nowrap px-6 py-4 flex justify-center gap-3 font-medium">
                    {
                      formatAmountWithCommas(Number(state.data.InvoiceMaster.Total_Discount))}
                  </td>
                </tr>
                <tr className="border-b border-neutral-200 dark:border-white/10">
                <td
                  ...
                  <td className="whitespace-nowrap px-6 py-4 flex justify-center gap-3 font-medium">
                    {state.data.InvoiceDetails.length &&
                      formatAmountWithCommas(Number(state.data.InvoiceMaster.TotalwithDiscount))}
                  </td>
                </tr>
              </tbody>
            </table>
