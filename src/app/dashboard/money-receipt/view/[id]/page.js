...
<h1>ID: {state.data.MRID}</h1>
<h1>Receipt Number: {state.data.MRNo}</h1>
<h1>Date: {state.data.MRDate}</h1>
<h1>Party Name: {state.data.PartyName}</h1>
<h1>Amount Received: {state.data.AmountReceived}</h1>
        </div>
    </div>
  )
}
