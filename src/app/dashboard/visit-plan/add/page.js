...
const page = () => {
  ...
  const purposeCategory = useGetData(
    'https://kblsf.site/DLogicKBL/salesforce_api.php?action=get_visitpurposes'
  );

  const getPerpouse = async () => {
    const res = await axios.post(
      'https://kblsf.site/DLogicKBL/salesforce_api.php?action=generate_new_visit_plan_number'
    );
    setFormData({
      ...formData,
